...
public class AccountModel {
    public static void readUserList(Context mContext, CheckAccountView checkAccountView) {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                addAccountModel(jsonObject, checkAccountView);
                            }
    ...
    public static void addAccountModel(JSONObject jsonObject, CheckAccountView checkAccountView) throws JSONException {
